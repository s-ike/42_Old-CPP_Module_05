...
/*   Updated: 2021/11/18 22:57:35 by sikeda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		Bureaucrat				bureaucrat("TESTER", 145);
...

	{
		...
		Bureaucrat				bureaucrat("TESTER137", 137);
...

	{
		...
		Bureaucrat			bureaucrat("TESTER45", 45);
...

	{
		...
		Bureaucrat				bureaucrat("TESTER5", 5);
